module.exports.config = {
    name: "Xemtt", // Tên lệnh, được sử dụng trong việc gọi lệnh
    version: "1.0.1", // phiên bản của module này
    hasPermssion: 0, // Quyền hạn sử dụng, với 0 là toàn bộ thành viên, 1 là quản trị viên trở lên, 2 là admin/owner
    credits: "DungUwU && Nghĩa", // Công nhận module sở hữu là ai
    description: "Xem tương tác ngày/tuần/toàn bộ", // Thông tin chi tiết về lệnh
...
const path = __dirname + '/_xemtuongtac_nghia/';
...
module.exports.run = async function ({ api, event, args, Users, Threads }) {
    ...
    } else if (query == 'tuần' || query == '-w') {
        header = '====Xemtt_Tuần====';
        data = threadData.week;
    } else if (query == 'ngày' || query == '-d') {
        header = '====Xemtt_Ngày====';
        data = threadData.day;
    } else {
        data = threadData.total;
