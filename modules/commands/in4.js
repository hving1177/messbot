...
💮 Biệt danh:  𝙃 𝙊 𝘼 𝙉 𝙂
❎ Ngày tháng năm sinh: 04/11/2011
👤 Giới tính: Nam
💫 Chiều cao cân nặng: 1m72 x 56kg
💘 Mối quan hệ: Hẹn hò
🌎 Quê quán: Hưng yên
🏰 Sống tại: Việt Nam
👫 Gu: dễ thương
🌸 Tính cách: dễ cáu,hay cọc rồi đánh người
🌀 Sở thích: Chơi game, nghe nhạc, ăn, ngủ
💻Contact💻
☎ SĐT&Zalo: 0977284114
🌐Facebook:
${global.config.FACEBOOK_ADMIN}
✉️ Email: hihitaofifai@gmail.com`,
    attachment: fs.createReadStream(__dirname + "/noprefix/sad.mp4")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/noprefix/sad.mp4"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100024736488842}/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
...
if (args[0] == "user") { 
    ...
    var gender = sex == 2 ? "Nam" : sex == 1 ? "Nữ" : "Trần đức bo" ;
