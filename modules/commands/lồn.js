...
"https://i.postimg.cc/gjVRbNpC/Suon-Xam-Voi-Cac-Buc-Anh-Sex-China-Lo-Thien-20-scaled.jpg",
  ...
  var money = data.money
      if(money < 10000) api.sendMessage("Bạn cần 100 đô để xem ảnh ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 10000})
   var callback = () => api.sendMessage({body:`𝗡𝗵𝘂̛̃𝗻𝗴 𝗰𝗵𝗶𝗲̂́𝗰 𝗹𝗼̂̀𝗻 𝗵𝘂̛ 𝗵𝗼̉𝗻𝗴 😼\n» 𝗦𝗼̂́ 𝗱𝘂̛: -𝟭0𝟬𝟬𝟬 đô «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
